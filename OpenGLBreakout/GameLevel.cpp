...
void GameLevel::init (std::vector<std::vector<GLuint>> tileData, GLuint levelWidth, GLuint levelHeight)
{
    ...
    GLuint height = (unsigned int) tileData.size ();
    GLuint width = (unsigned int) tileData[0].size (); // Note we can index vector at [0] since this function is only called if height > 0
